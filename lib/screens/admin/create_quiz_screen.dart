...
/// Create Quiz Screen
/// Allows admins to create new quizzes with questions
...
class _CreateQuizScreenState extends State<CreateQuizScreen> {
  ...
  void _addQuestion() {
    showModalBottomSheet(
      ...
      builder: (context) => QuestionBuilderWidget(
        onSave: (question) {
          setState(() {
            _questions.add(question.copyWith(order: _questions.length + 1));
          });
  ...
  void _editQuestion(int index) {
    showModalBottomSheet(
      ...
      builder: (context) => QuestionBuilderWidget(
        ...
        onSave: (question) {
          setState(() {
            _questions[index] = question.copyWith(order: index + 1);
          });
          Navigator.pop(context);
        },
      ),
  ...
  Future<void> _saveQuiz() async {
    ...
    try {
      ...
      await quizProvider.createQuizWithQuestions(quiz, _questions);
